...
half FloatToHalf(float f)
{
	...
	int s = (x.i >> 16) & 0x00008000;
	int e = ((x.i >> 23) & 0x000000ff) - (127 - 15);
	...
	else
	{
		...
		if (e > 30)
		{
			...
			return { (unsigned short)(s | 0x7c00) };	// if this returns, the half becomes an
		}   			// infinity with the same sign as f.
